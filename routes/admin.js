    ...
    //POST
                ...
                var erros = [];
                    ...
                    if (erros.length > 0) {
                        ...
                        new Categorias(novaCategoria).save().then(()=>{
                            req.flash("success_msg", `Nova categoria ${req.body.nome} cadastrada com sucesso`);
                            res.redirect("/admin/categorias");
                            console.log(`Nova categoria ${req.body.nome} cadastrada com sucesso`);
                        }).catch((err)=>{
        ...
        router.post("/categorias/deletar",  eAdmin, (req, res)=>{
            Categorias.remove({_id: req.body.id}).then(()=>{
                ...
                req.flash("erro_msg", "Houve um erro ao tentar deletar a acategoria");
                res.redirect("/admin/categorias");
            });
        });
        ...
        router.post("/postagens/nova", eAdmin, (req, res)=>{
            ...
            if(erros.length > 0 ){
                ...
                new Postagem(novaPostagem).save().then(()=>{
                    ...
                    res.redirect("/admin/postagens");
                    console.log(`Nova categoria ${req.body.titulo}, cadastrada com sucesso`);
                }).catch((err)=>{
                    req.flash("error_msg", "Houve um erro durante o salvamento da paostagem");
                    res.redirect("/admin/postagens");
                    console.log("Erro" + err);
                })
        ...
        router.post("/postagens/edit", eAdmin, (req, res)=>{
            ...
            Postagem.findOne({_id: req.body.id}).then((postagem)=>{
                ...
                postagem.save().then(()=>{
                    ...
                    req.flash("error_msg", "Hpuve um erro ao salvar a edição");
                    res.redirect("/admin/postagens")
                })
